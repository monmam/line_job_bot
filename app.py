...
def parse_job_text(raw_text, fallback_id="F01"):
    ...
    # 1. ค้นหาจากแท็ก 【接รับ】 และ 【送ส่ง】 ก่อนเป็นอันดับแรก (ป้องกันปัญหาเครื่องหมาย - ในชื่อโรงแรม)
    ...
    if pickup_raw_match:
        ...
        # ตัดข้อความส่วนเกินหลังวงเล็บหรือสัญลักษณ์ถ้ามี
    ...
    # 2. หากไม่เจอแท็กชัดเจนค่อยลองหาจากบรรทัดที่มีเครื่องหมาย - ทั่วไป
