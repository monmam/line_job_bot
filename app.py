...
def parse_job_text(raw_text, fallback_id="F01"):
    ...
    # 1. ดึงค่าจากแท็ก 【接รับ】 และ 【送ส่ง】 ก่อนเป็นอันดับแรก
    ...
    if pickup_raw_match:
        ...
        # ตัดวงเล็บพิกัดหรือรายละเอียดส่วนเกินออก เช่น Manhattan Hotel Bangkok)13 -> Manhattan Hotel Bangkok
    ...
    # 2. หากไม่เจอแท็ก ให้ลองเช็คหาจากบรรทัดที่มีเครื่องหมาย - เป็นวิธีสำรอง
    ...
    # แปลงชื่อจุดรับ-จุดส่งผ่านกฎการแมป
